...
final restTimerProvider = AutoDisposeFutureProvider<int>.internal(
  restTimer,
...
/// See also [ModelRotationMode].
@ProviderFor(ModelRotationMode)
final modelRotationModeProvider =
    AutoDisposeAsyncNotifierProvider<ModelRotationMode, String>.internal(
      ModelRotationMode.new,
      name: r'modelRotationModeProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$modelRotationModeHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );
