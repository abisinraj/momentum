...
String _$sessionHistoryHash() => r'30f1cc99d0ce96efaa31d1cdbc24f8e2223fa310';
...
class SessionHistoryFamily
  ...
  ///
  /// Copied from [sessionHistory].
  SessionHistoryProvider call({int limit = 20}) {
    return SessionHistoryProvider(limit: limit);
  }
...
class SessionHistoryProvider
  ...
  ///
  /// Copied from [sessionHistory].
  SessionHistoryProvider({int limit = 20})
    : this._internal(
        (ref) => sessionHistory(ref as SessionHistoryRef, limit: limit),
...
String _$sessionExerciseDetailsHash() =>
    r'3133ded3828e60e448aad5f753d2852a2c530395';
